...
- DO focus on whether the assistant correctly identified the same forensic anomalies, biological evidence, and medical logic as described in the Ground Truth. Reward the response outputting correctbbox coordinate.
...
def process_single_task(client, sample, model_name, response_text):
    ...
    try:
        # API Call with Thinking Config (Text-only)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gemini 3 Pro Multi-threaded Text-only LLM-as-Judge")
